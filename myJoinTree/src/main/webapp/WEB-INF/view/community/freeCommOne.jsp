...
<html>
	...
	<body>
		<a href="/myJoinTree/community/freeCommList">이전</a>
		...
		<c:if test="${loginAccount.empNo eq comm.empNo}">
			<a href="/myJoinTree/community/freeCommList/modifyFreeComm?boardNo=${comm.boardNo}">수정</a>
			<a href="/myJoinTree/community/freeCommList/removeFreeComm?boardNo=${comm.boardNo}">삭제</a>
		</c:if>
	</body>
</html>