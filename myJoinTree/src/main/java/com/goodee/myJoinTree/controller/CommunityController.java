...
import com.goodee.myJoinTree.service.CommunityService;
import com.goodee.myJoinTree.vo.Board;
import com.goodee.myJoinTree.vo.BoardFile;
...
public class CommunityController {
	...
	public String freeCommList(Model model, @RequestParam(name = "currentPage", defaultValue = "1") int currentPage,
		...
		log.debug(CYAN + resultMap.get("pinnedCommList") + " <-- commList(CommunityController-freeCommList)" + RESET);
