...
import com.goodee.myJoinTree.mapper.EmpInfoImgMapper;
import com.goodee.myJoinTree.mapper.EmpInfoMapper;
...
public class EmpInfoService {
	...
	public Map<String, Object> getEmpOne(int empNo) {
		...
		// map.put("empInfo", empInfoMapper.selectEmpOne(empNo));
		// map.put("empInfoImg", empInfoImgMapper.selectEmpImg(empNo));
	...
	// 나의 이미지 삭제
	public int removeEmpImg(int empNo) {
		int row = 0;
